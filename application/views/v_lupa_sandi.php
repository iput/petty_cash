        ...
        <div class="register-box">
            ...
            <div class="register-box-body">
                ...
                <form action="" method="post">
                    <label>Masukan email anda untuk menerima konfirmasi pemilihan kata sandi</label>
                    <div class="form-group has-feedback">
                        <input type="text" name="txt_lupa_sandi" class="form-control" placeholder="email address">
